...
export default function CarbonTracker() {
  ...
  useEffect(() => {
    ...
    lineInst.current = new Chart(lineRef.current, {
      ...
      data: {
        labels: dailyData.map((d) => d.day),
        datasets: [
          { label: "CO₂ Emitted", data: co2Data, borderColor: "#c0354a", backgroundColor: "rgba(192,53,74,0.07)", fill: true, tension: 0.4, pointBackgroundColor: "#c0354a", pointRadius: 4 },
          { label: "Target",      data: dailyData.map(() => 5), borderColor: "#2ca05a", borderDash: [5, 4], pointRadius: 0, borderWidth: 1.5 },
        ],
      },
      options: {
        responsive: true, maintainAspectRatio: false,
  ...
  const stats = [
    { icon: <svg viewBox="0 0 24 24"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>,                   cls: "blue",  label: "Energy Used",     value: `${totalUnits.toFixed(1)} kWh` },
    { icon: <svg viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>,                     cls: "rose",  label: "CO₂ Emitted",     value: `${carbonKg} kg` },
    { icon: <svg viewBox="0 0 24 24"><path d="M17 8C8 10 5.9 16.17 3.82 19.34A1 1 0 004.7 21C8 19 9 18 12 18c0 0 5-3 5-10z"/><line x1="12" y1="18" x2="12" y2="22"/></svg>, cls: "green", label: "Trees to Offset", value: treesNeeded },
    { icon: <svg viewBox="0 0 24 24"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>, cls: "amber", label: "Emission Factor", value: "0.695" },
  ];

  const LevelIcon = () => {
    const s = { width: 30, height: 30, stroke: levelColor, fill: "none", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round" };
    if (level === "High")     return <svg viewBox="0 0 24 24" style={s}><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>;
    if (level === "Moderate") return <svg viewBox="0 0 24 24" style={s}><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>;
    return <svg viewBox="0 0 24 24" style={s}><path d="M17 8C8 10 5.9 16.17 3.82 19.34A1 1 0 004.7 21C8 19 9 18 12 18c0 0 5-3 5-10z"/><line x1="12" y1="18" x2="12" y2="22"/></svg>;
  };

  return (
    <div className="page">
      <img className="page-img-strip" src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1200&q=75&fit=crop" alt="Forest" />
      ...
      {/* Status */}
      <div className="premium-card" style={{ textAlign: "center", padding: "32px 24px", marginBottom: 16, background: levelBg, border: `1.5px solid ${levelBorder}` }}>
        <div style={{ width: 64, height: 64, borderRadius: 18, background: levelBg, border: `1.5px solid ${levelBorder}`, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 12px" }}>
          <LevelIcon />
        </div>
      ...
      <div className="chart-grid">
        <div className="premium-card">
          ...
          <div className="chart-canvas-wrap"><canvas ref={barRef} role="img" aria-label="Daily CO2 bar chart" /></div>
        </div>
        <div className="premium-card">
          ...
          <p className="info-text" style={{ textAlign: "center", marginTop: 10, fontSize: 12 }}>{treesNeeded} trees × 21.77 kg CO₂/yr</p>
        </div>
      </div>
      ...
      <div className="premium-card" style={{ marginBottom: 16 }}>
        ...
        <div className="chart-canvas-wrap" style={{ height: 170 }}><canvas ref={lineRef} role="img" aria-label="CO2 vs target line chart" /></div>
      </div>
