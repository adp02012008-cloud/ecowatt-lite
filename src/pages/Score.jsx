    ...
    <div className="page">
      <div className="page-title-row">
        <div>
          ...
          <h1>Eco Score</h1>
          <p className="subtext">
            A summarized sustainability score derived from current monitored energy usage
          </p>
        </div>
      </div>
        ...
        <div className="premium-card score-panel">
          ...
          <div
            ...
            style={{
              ...
              boxShadow: `0 0 30px ${getScoreColor(ecoScore)}`
            }}
          >
            {ecoScore}
          </div>
      ...
      <div className="premium-card">
        <p className="section-tag">Score Logic</p>
        <h2>How Eco Score Is Calculated</h2>
        <p className="info-text">
          The eco score is derived from the estimated carbon output generated by
          the monitored weekly energy usage. Lower carbon impact results in a
